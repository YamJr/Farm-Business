...
FarmerSignUp.addEventListener('click', () => {
    ...
    console.log(validFname, validLname, validDob, validPhone, validEmail, validPassword)
    if (validFname && validLname && validDob && validPhone && validEmail && validAcre && validPassword) {
